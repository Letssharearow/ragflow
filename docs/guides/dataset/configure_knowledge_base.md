...
_Each time a dataset is created and file is directly added to the dataset, a folder with the same name is generated in the **root/.knowledgebase** directory._
